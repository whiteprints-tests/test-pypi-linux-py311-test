...
project = "test pypi linux py311-test"
...
release = metadata.version("test_pypi_linux_py311_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-pypi-linux-py311-test",
            "icon": "fa-brands fa-square-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/test-pypi-linux-py311-test",
